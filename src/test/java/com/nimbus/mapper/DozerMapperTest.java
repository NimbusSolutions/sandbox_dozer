...
public class DozerMapperTest {
    ...
    private DozerMapper objectUnderTest;

    @BeforeMethod
    private void beforeMethod() {
        objectUnderTest = new DozerMapper();
    }
    ...
    public void testMappingSimpleBean() {
        ...
        // forwards
        {
            ...
            PassengerEntity target = objectUnderTest.map(source);
        ...
        //reversed
        {
            ...
            Passenger target = objectUnderTest.map(source);
    ...
    public void testMappingComplexBean() {
        ...
        // forwards
        {
            ...
            JourneyEntity target = objectUnderTest.map(source);
        ...
        // reversed
        {
            ...
            Journey target = objectUnderTest.map(source);
